...
public static class Ease{
    ...
    public static readonly Ease.Easer
        SineIn = (Ease.Easer)(t => (float)(-Math.Cos(1.57079637050629 * (double)t) + 1.0));
    ...
    public static readonly Ease.Easer ElasticIn = (Ease.Easer)(t => {
        float num1 = t * t;
        float num2 = num1 * t;
        return (float)(33.0 * (double)num2 * (double)num1 + -59.0 * (double)num1 * (double)num1 + 32.0 * (double)num2 +
                       -5.0 * (double)num1);
    });
    ...
    public static readonly Ease.Easer BounceOut = (Ease.Easer)(t => {
        ...
        return (double)t < 0.909090936183929
            ? (float)(121.0 / 16.0 * ((double)t - 0.818181812763214) * ((double)t - 0.818181812763214) + 15.0 / 16.0)
            : (float)(121.0 / 16.0 * ((double)t - 0.954545438289642) * ((double)t - 0.954545438289642) + 63.0 / 64.0);
    });
    ...
    public static Ease.Easer Follow(Ease.Easer first, Ease.Easer second){
        return (Ease.Easer)(t =>
            (double)t > 0.5 ? (float)((double)second((float)((double)t * 2.0 - 1.0)) / 2.0 + 0.5) : first(t * 2f) / 2f);
    }
